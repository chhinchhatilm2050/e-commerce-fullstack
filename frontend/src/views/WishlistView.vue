  ...
  <div class="container-xl px-8 py-5">
    ...
    <div v-else-if="wishlistStore.items.length === 0" class="text-center py-20">
      <p class="text-center font-semibold text-xl">
        <i class="ri-remix-line"></i> Your wishlist is currently empty.
      </p>
      <router-link
        to="/products/category/books"
        class="mt-5 default-button inline-block text-sm"
    ...
    <div
      v-else
      class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-slide-up"
    >
      <WishlistCard
