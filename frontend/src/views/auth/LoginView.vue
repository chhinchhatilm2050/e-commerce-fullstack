    ...
    <div class="relative w-full max-w-md animate-slide-up">
      <div class="bg-white dark:bg-surface-800 rounded-3xl">
        <p
          ...
          class="default-button w-full cursor-default bg-red-50 text-sm text-red-700 mb-2 text-center"
        >
          {{ authStore.authError }}
        </p>
        <form @submit.prevent="handleLogin">
          ...
          <div>
            <div class="flex mt-3 items-center justify-between mb-0.5">
              ...
              <a
                ...
                class="text-xs text-gray-800 cursor-pointer hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-400 font-medium"
        ...
        <div class="flex justify-center items-center flex-col gap-3">
          ...
          >
            ...
            >
              <path
                d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.118 4.388 23.118 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.791-4.697 4.533-4.697 1.313 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.886v2.267h3.328l-.532 3.49h-2.796V24C19.612 23.118 24 18.118 24 12.073z"
              />
            </svg>
            Facebook
          </button>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
          ...
          <button
            type="button"
            class="text-gray-800 font-semibold hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-400 cursor-pointer"
